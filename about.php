  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6 order-last padding-0 md-pl-15 md-pr-15 md-mb-30">
        <div class="img-part">
          <img class="" src="admin/images/about/<?php echo $imgs; ?>" alt="About Image">
        </div>
      </div>
      <div class="col-lg-6 pr-70 md-pr-15">
        <div class="sec-title">
          <div class="sub-title orange">About Madok</div>
        ...
        while ($data=mysqli_fetch_assoc($run)) {
              ...
              <div class="team-item">
                  ...
                  <div class="content-part">
                      <h4 class="name"><a href="team-single.html"><?php echo $data['name']; ?></a></h4>
