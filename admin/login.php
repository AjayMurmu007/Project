                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card overflow-hidden">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="p-2">
                                    <form class="form-horizontal" action="action/login_action.php" method="POST">
                                        <div class="mb-3">
                        ...
                        <div class="mt-5 text-center">
                            <div>
                                <p>© <script>document.write(new Date().getFullYear())</script> Madok. Crafted with <i class="mdi mdi-heart text-danger"></i> by Uinfotechnology</p>
                            </div>
                        </div>
                    </div>
                </div>
