                       ...
                       <form class="custom-validation" action="action/course_action.php" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <input type="text" name="ctype" id="ctype" class="form-control" placeholder="course type" />
                                </div>
                            </div>
                            <div class="mb-3">
                              <div class="row">
          ...
          <div class="col-lg-12">
              <div id="inputFormRow">
                  <div class="input-group mb-3">
                      <input type="text" name="duration[]" class="form-control m-input" placeholder="course duration" autocomplete="off">
                      <input type="text" name="price[]" class="form-control m-input" placeholder="course price" autocomplete="off">
              ...
              <button id="addRow" type="button" class="btn btn-info">Add Row</button>
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                <textarea id="editor"  name="notes" class="form-control" rows="3"></textarea>
                            </div>
                        </div>
