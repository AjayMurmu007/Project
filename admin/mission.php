        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="custom-validation" action="action/mission_vision_action.php" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <?php
                             if (!empty($imgs)) {
                               ?>
                               <img src="images/missionandvission/<?php echo $imgs; ?>" alt="">
                               <?php
                             }
                            ?>
                        </div>
                        <div class="mb-3">
                            ...
                            <div>
                                <textarea  name="notes" class="form-control" rows="3"><?php echo $description; ?></textarea>
                            </div>
                        </div>
