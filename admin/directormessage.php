        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="custom-validation" action="action/director_message_action.php" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <?php
                             if (!empty($imgs)) {
                               ?>
                               <img src="images/director/<?php echo $imgs; ?>" alt="">
                               <?php
                             }
                            ?>
                        </div>
